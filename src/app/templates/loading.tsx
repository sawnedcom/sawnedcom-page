  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 py-16 font-poppins">
      <div className="text-center">
        ...
        {/* Loading Text */}
        <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 mb-4">Loading Templates</h2>
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-md mx-auto">Welcome to my templates</p>
      </div>
    </div>
  );
}
